...
<html lang="en">
    ...
    def get_page(self, url, path, query=None):
        ...
        try:
            return self.internet_db[url][path]
        except:
            pass
        ...
        generated_page_completion = self.client.chat.completions.create(
            ...
            model=self.model,  # What a great model, works near perfectly with this, shame its only got 8k context (does Ollama even set it to that by default?)
